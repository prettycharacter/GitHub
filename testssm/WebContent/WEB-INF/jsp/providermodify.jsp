...
<%@include file="common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/pro/proupdatesave">
			...
			<font color="red"></font>
              ...
              <div class="prodesc">
                 <%--  <input type="text" name="proDesc" id="proDesc" value="${provider.proDesc }"> --%> 
                  <textarea id="proDesc" name="proDesc" rows="8" cols="30">${provider.proDesc}</textarea>
              </div>
